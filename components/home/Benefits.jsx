    ...
    return (
        <>
            <section id="benefits" className="w-full flex flex flex-col max-w-[1200px] mx-auto">
                <h2 className="text-4xl sm:text-5xl text-dark font-bricolage p-8 text-center tracking-wider ">Co
                    nas wyróżnia?</h2>
                <div className="flex flex-1 flex-row flex-wrap justify-center">
                    {benefits.map((benefit, index) => (
                        <div key={index}
                             className="circle bg-gradient-to-b from-light to-dark box-with-shadow my-5 sm:mx-5 ">
                            <div
