            ...
            <section id="about" className="w-full rounded-[10px] flex p-3 sm:p-8 flex justify-evenly items-center">
                <div className="flex flex-col md:flex-row justify-evenly items-center ">
                    ...
                    <div className="flex flex-col sm:flex-row max-w-[800px] min-w-[350px] ">
                        ...
                        <div className="mx-1 my-5 sm:m-5 p-3 sm:p-5 bg-primary box-with-shadow rounded-[20px]">
                            <h2 className="text-4xl sm:text-5xl text-green font-bricolage p-8 text-with-shadow text-center tracking-wider ">Space
                                Mobile House</h2>
                            ...
                            <p className="p-8 mb-[50px] lg:my-[70px] bg-green text-primary text-center box-with-shadow rounded-[20px]">
                            ...
                            <div className="flex flex-col justify-evenly items-center mx-1 my-9 text-center bg-green box-with-shadow rounded-[20px]">
                                    <h2 className="text-2xl text-primary font-bold tracking-wider pt-4">Misja:</h2>
                                    <p className="p-8 text-primary">
                    ...
                    <div className="flex flex-col sm:flex-row md:flex-col flex-wrap justify-evenly items-center m-2">
                        <a src="/houses"
                            className="p-4 my-[20px] rounded-[20px] bg-primary flex flex-col justify-center items-center cursor-pointer">
                            <img alt="beautiful house and lake" src="/assets/images/houses.jpg" className="w-[300px]  min-w-[200px] px-4 sm:mb-3 py-3 rounded-[20px] box-with-shadow bg-green"/>
                        ...
                        {abouts.map((about, index)=> (
                            <Link key={index}
                                ...
                                className="p-4 my-[20px] rounded-[20px] bg-primary flex flex-col justify-center items-center cursor-pointer">
                                <img alt={about.alt} src={about.src} className="w-[300px] min-w-[200px]  sm:mb-3 md:mb-1 rounded-[20px] box-with-shadow"/>
