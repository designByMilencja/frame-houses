...
export const questions1 = ['Ważna jest dla Ciebie elastyczność i niezależność?', 'Preferujesz bardziej ekonomiczne rozwiązania mieszkalne?', 'Czerpiesz z natury i widzisz korzyści w zmianie otoczenia?',];
export const questions2 = ['Zwracasz uwagę na ekologię i zrównoważony lifestyle?', 'Potrzebujesz przestrzeni, którą możesz dostosować do swoich potrzeb?', 'Cenisz sobie szybkość budowy i błyskawiczną gotowość do zamieszkania?', 'Zwracasz uwagę na standardy bezpieczeństwa i jakości w swoim miejscu zamieszkania?'];
export const benefits = [{
    ...
    desc: "Tworzymy energooszczędne rozwiązania. Wyposażamy nasze domki mobilne w systemy odnawialnej energii," + " takie jak panele słoneczne i systemy do odzyskiwania energii. To nie tylko zmniejsza koszty eksploatacyjne dla użytkowników, ale także przyczynia się do zrównoważonego stylu życia."
}, {
...
export const abouts = [{
    ...
    alt: "house near the lake",
    text: "Sprawdź etapy produkcji"
}, {
    src: "/assets/images/idea.jpg",
    href: "#advantages",
    alt: "person pointing finger up",
    text: "Domek mobilny dla Ciebie?"
}, {
    src: "/assets/images/equipment.jpg",
    href: "/production#equipment",
    alt: "table and plants",
    text: "Wyposażenie domów mobilnych"
},]
export const pluses = [{
    title: "Mobilność",
    desc: "Domki mobilne są przenośne, co oznacza, że można je łatwo przewozić z miejsca na miejsce. To idealne" + " rozwiązanie dla osób, które pragną zmieniać lokalizację czy podróżować, ale mogą mieć też stałe miejsce" + " bez konieczności wprowadzania zmian"
}, {
    title: "Dostosowanie do Potrzeb",
    desc: "Domki mobilne możesz dostosować do indywidualnych potrzeb. Możesz wybrać rozkład pomieszczeń," + " wykończenia i dodatki, aby stworzyć dom dokładnie tak, jak tego potrzebujesz."
}, {
    title: "Energooszczędność",
    desc: "Są zaprojektowane z myślą o efektywnym wykorzystaniu energii. Mogą być dobrze izolowane i wyposażone w" + " systemy oszczędzania energii, co prowadzi do niższych rachunków za prąd i ogrzewanie."
}, {
    title: "Szybka Budowa",
    ...
    desc: "Domki mobilne są mniejsze niż tradycyjne domy, co oznacza, że są łatwiejsze do utrzymania w" + " czystości i konserwacji."
}, {
    title: "Dostęp do Natury",
    desc: "Możesz umieścić swój domek mobilny na działce lub kempingu, możesz cieszyć się bliskością natury i" + " spokojem na co dzień."
}, {
    title: "Koszty",
    desc: "Domki mobilne są dużo tańsze niż tradycyjne domy. Zarówno koszty zakupu, jak i utrzymania mogą być" + " znacznie niższe, co pozwala zaoszczędzić pieniądze."
}, {
    title: "Ekologia",
    ...
    title: "Różnorodność",
    desc: "W naszej ofercie dostępne są różne style i rozmiary domków mobilnych, co pozwala znaleźć rozwiązanie" + " odpowiednie dla Twoich preferencji i potrzeb."
},]
...
export const steps = [{
    ...
    desc: "Fundamenty  Przygotowanie fundamentu lub podstawy, na której będzie umieszczony dom mobilny. Może to być betonowa podpora lub specjalny podkład," + " w zależności od konkretnego projektu.",
    src: "/assets/images/production.jpg",
    alt: 'description'
}, {
    id: 4,
...
export const mobileHouses = [{
    id: '1',
    title: "Model 1",
    src: '/assets/images/house.jpg',
    desc: 'Parterowy dom, składający się z dwóch modułów dostarczanych na działkę jako kompletne wykończone i' + ' zestawianych w całość. Domek o tradycyjnej architekturze, z dwuspadowym dachem. Dostępnych jest wiele wersji wielkości, wariantów funkcjonalnych wnętrza oraz wykończenia elewacji.',
...
export const productionBox = {
    ...
    h3: "Przyjrzyjmy się bliżej etapom budowy domów mobilnych, od początkowej koncepcji po finalny produkt." + " Dowiedzmy się, jakie są kluczowe kroki i wyzwania związane z tym procesem oraz jakie korzyści płyną z wyboru tego nowoczesnego rozwiązania."
}

export const products = {
    h2: "Rodzaje naszych produktów",
    h3: " Oferujemy szeroką gamę domków mobilnych i modułowych, które dostosowujemy do różnorodnych potrzeb" + " klientów, jesteśmy otwarci na pomysły, które chętnie wcielamy w życie.",
    houses: [{
        h4: "Domki Mobilne",
        p: "Nasze klasyczne domki mobilne łączą w sobie minimalistyczny design z funkcjonalnością. Są one" + " idealnym rozwiązaniem dla osób, które pragną mieć swoje cztery kąty, mimo niestety wygórowananych ceny" + " mieszkań na rynku. W rezultacie, nasze domki mobilne nie tylko odzwierciedlają nasze zaangażowanie w" + " innowacyjność i jakość, ale stanowią również dowód na naszą zdolność do tworzenia przyszłościowej i" + " zrównoważonej przestrzeni mieszkalnej dla naszych klientów bez wygórowanych kosztów.",
        imageUrl: '/assets/images/house.jpg',
    }, {
        h4: "Domki modułowe",
        p: "  Specjalnie zaprojektowane domki modułowe oferują przestronne wnętrza, idealne dla rodzin." + " Wyposażone w różnego rodzaju udogodnienia, zapewniają przytulne miejsce do spędzania czasu razem." + " Domki modułowe to rewolucyjny sposób na tworzenie przestrzeni mieszkalnych, łączący nowoczesność, wygodę i innowację. Nasze domki modułowe redefiniują pojęcie mieszkania i oferują niezrównany komfort w zgodzie z duchem czasu.",
...
export const about = {
    ...
    p1a: 'Nasza firma specjalizuje się w',
    p1b: 'projektowaniu, produkcji i dostarczaniu wysokiej jakości domków mobilnych',
    p1c: 'Łączy funkcjonalność, estetykę i innowacyjność, aby stworzyć komfortowe przestrzenie mieszkalne' + ' dostosowane do potrzeb współczesnego stylu życia. Znamy rynek jak nikt oraz bacznie przyglądamy sie' + ' oczekiwaniom naszych klientów, badamy potrzeby aby dopasować nasze produkty dla każdej osoby indywidualnie. Państwa komfort to nasz wyznacznik sukcesu.',
    p2: ' Główna siedziba mieści się w Warszawie, ale dzięki rozwiązaniu z ruchomą platformą, domki jesteśmy w' +
        ' stanie dostarczyć w niemalże każde miejsce na świecie. Wszelkie szczegóły zawsze omawiamy indywidualnie,' +
        ' by jak najbardziej wyjść naprzeciw potrzebom naszych klientów. Wiemy, że tylko indywidualne podejście pozwala osiągnąć zamierzone cele.',
    h3: 'Misja:',
    p3a: 'Dostarczamy klientom domy mobilne, które łączą w sobie',
